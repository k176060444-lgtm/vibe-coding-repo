...
| `GIT_INTEGRATION_GATE_PASS_RECEIPT` | vibedev/orchestrator | REVIEW_GATE_PASS_RECEIPT for the same Git Integration operation + Integration Packet assembly + freeze + validation + PRE_DRAFT_GIT_INTEGRATOR_BINDING, where the canonical row subject is the Git Integration Packet (`INTEGRATION_INPUT_FROZEN`) |INTEGRATION_INPUT_FROZEN (the Git Integration Packet)|`INTEGRATION_INPUT_FROZEN`, `CANDIDATE_TRIPLE`, `REVIEW_INPUT_PACKET`, `GIT_OPERATION_REF`, `GIT_INTEGRATOR_ROLE_TRIPLE`, `GIT_CROSS_VERIFICATION_REF`|`REVIEW_GATE_PASS_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`| AND(CURRENT(REVIEW_GATE_PASS_RECEIPT, REVIEW_INPUT_PACKET), STATE_CREATED(REVIEW_GATE_PASS_RECEIPT, REVIEW_INPUT_PACKET, GATE_PASS), CURRENT(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_ASSEMBLED), CURRENT(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_FROZEN), CURRENT(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_VALIDATED), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE), STATE_CREATED(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, GIT_INTEGRATOR_PRE_DRAFT_BOUND), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFIED), PACKET_BINDS(REVIEW_INPUT_PACKET, CANDIDATE_TRIPLE), PACKET_BINDS(INTEGRATION_INPUT_FROZEN, CANDIDATE_TRIPLE), STAGE_IS(GIT_INTEGRATION), ROW_SUBJECT_IS(INTEGRATION_INPUT_FROZEN), SAME_OPERATION(INTEGRATION_INPUT_FROZEN, GIT_CROSS_VERIFICATION_REF, GIT_OPERATION_REF)) | GIT_OBJECT, DIFF_MANIFEST, PR_METADATA_SNAPSHOT | PASS | GATE_PASS |
| `GIT_INTEGRATION_GATE_FAIL_RECEIPT` | vibedev/orchestrator | integration-stage Evidence of stop or rejection on the same Git Integration operation; the canonical row subject remains the Git Integration Packet (`INTEGRATION_INPUT_FROZEN`) |INTEGRATION_INPUT_FROZEN (the Git Integration Packet)|`INTEGRATION_INPUT_FROZEN`, `CANDIDATE_TRIPLE`, `REVIEW_INPUT_PACKET`, `GIT_OPERATION_REF`, `GIT_INTEGRATOR_ROLE_TRIPLE`, `GIT_CROSS_VERIFICATION_REF`|`ARTIFACT_VALIDATION_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`, `REVIEW_GATE_PASS_RECEIPT`, `ROLE_CROSS_VERIFICATION_RECEIPT`| AND(CURRENT(REVIEW_GATE_PASS_RECEIPT, REVIEW_INPUT_PACKET), STATE_CREATED(REVIEW_GATE_PASS_RECEIPT, REVIEW_INPUT_PACKET, GATE_PASS), CURRENT(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_ASSEMBLED), CURRENT(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_VALIDATED), CURRENT(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_FROZEN), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE), STATE_CREATED(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, GIT_INTEGRATOR_PRE_DRAFT_BOUND), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFIED), PACKET_BINDS(REVIEW_INPUT_PACKET, CANDIDATE_TRIPLE), PACKET_BINDS(INTEGRATION_INPUT_FROZEN, CANDIDATE_TRIPLE), STAGE_IS(GIT_INTEGRATION), ROW_SUBJECT_IS(INTEGRATION_INPUT_FROZEN), SAME_OPERATION(INTEGRATION_INPUT_FROZEN, GIT_CROSS_VERIFICATION_REF, GIT_OPERATION_REF), OR(AND(STATE_CREATED(ARTIFACT_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, ARTIFACT_VALIDATION_INVALID), DECISION(ARTIFACT_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, INVALID)), AND(STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFICATION_INCOMPLETE), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, INCOMPLETE)), AND(STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFICATION_REJECTED), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, REJECTED)))) | GIT_OBJECT, DIFF_MANIFEST, PR_METADATA_SNAPSHOT | FAIL | GATE_FAIL |
| `DRAFT_PR_DELIVERY_RECEIPT` | git-integrator | GIT_INTEGRATION_GATE_PASS_RECEIPT + CANDIDATE_TRIPLE + PR |PR triple|`PR_TRIPLE`, `GIT_OPERATION_REF`, `GIT_INTEGRATOR_ROLE_TRIPLE`|`GIT_INTEGRATION_GATE_PASS_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`| AND(CURRENT(GIT_INTEGRATION_GATE_PASS_RECEIPT, GIT_OPERATION_REF), STATE_CREATED(GIT_INTEGRATION_GATE_PASS_RECEIPT, GIT_OPERATION_REF, GATE_PASS), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE), STATE_CREATED(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, GIT_INTEGRATOR_PRE_DRAFT_BOUND)) | GIT_OBJECT, PR_METADATA_SNAPSHOT | DELIVERED / FAILED | DRAFT_DELIVERED / DRAFT_DELIVERY_FAILED |
| `POST_DRAFT_DRAFT_TO_READY_BINDING_RECEIPT` | git-integrator (per-stage, post-Draft re-authorization for Draft→Ready operation) | stage-specific post-Draft binding for Draft→Ready operation |`DRAFT_TO_READY_APPROVAL_PACKET` triple + git-integrator stage Activation Evidence|`DRAFT_TO_READY_APPROVAL_PACKET`, `DRAFT_TO_READY_OPERATION_REF`, `DRAFT_TO_READY_INVOCATION_REF`, `PR_TRIPLE`|`OPERATOR_DRAFT_TO_READY_AUTHORIZATION_RECEIPT`, `DRAFT_PR_DELIVERY_RECEIPT`, `ROLE_ACTIVATION_READINESS_RECEIPT`| AND(CURRENT(OPERATOR_DRAFT_TO_READY_AUTHORIZATION_RECEIPT, DRAFT_TO_READY_OPERATION_REF), STATE_CREATED(OPERATOR_DRAFT_TO_READY_AUTHORIZATION_RECEIPT, DRAFT_TO_READY_OPERATION_REF, OPERATOR_AUTHORIZED_DRAFT_TO_READY), CURRENT(DRAFT_PR_DELIVERY_RECEIPT, PR_TRIPLE), STATE_CREATED(DRAFT_PR_DELIVERY_RECEIPT, PR_TRIPLE, DRAFT_DELIVERED), CURRENT(ROLE_ACTIVATION_READINESS_RECEIPT, DRAFT_TO_READY_INVOCATION_REF), STATE_CREATED(ROLE_ACTIVATION_READINESS_RECEIPT, DRAFT_TO_READY_INVOCATION_REF, ROLE_ACTIVATION_READY), SAME_OPERATION(DRAFT_TO_READY_APPROVAL_PACKET, DRAFT_TO_READY_OPERATION_REF, DRAFT_TO_READY_INVOCATION_REF)) | MODEL_INVOCATION_RECORD (stage-specific), GIT_OBJECT, OPERATOR_DECISION_RECORD | BOUND / UNBOUND | GIT_INTEGRATOR_DRAFT_TO_READY_BOUND / GIT_INTEGRATOR_DRAFT_TO_READY_UNBOUND |
| `READY_TRANSITION_RECEIPT` | vibedev/orchestrator | operator Draft→Ready authorization + DRAFT_PR_DELIVERY + DRAFT_TO_READY_APPROVAL_PACKET assembly + freeze + validation + POST_DRAFT_DRAFT_TO_READY_BINDING + git-integrator completion Evidence + cross-verification + STAGE_IS(DRAFT_TO_READY) (`BRANCH_DELETION_RECEIPT` is terminal post-BD cleanup) |PR triple|`DRAFT_TO_READY_APPROVAL_PACKET`, `PR_TRIPLE`, `DRAFT_TO_READY_OPERATION_REF`, `DRAFT_TO_READY_INVOCATION_REF`, `READY_CROSS_VERIFICATION_REF`, `READY_TRANSITION_COMPLETION_REPORT`|`OPERATOR_DRAFT_TO_READY_AUTHORIZATION_RECEIPT`, `DRAFT_PR_DELIVERY_RECEIPT`, `POST_DRAFT_DRAFT_TO_READY_BINDING_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `ROLE_CROSS_VERIFICATION_RECEIPT`| AND(CURRENT(OPERATOR_DRAFT_TO_READY_AUTHORIZATION_RECEIPT, PR_TRIPLE), STATE_CREATED(OPERATOR_DRAFT_TO_READY_AUTHORIZATION_RECEIPT, PR_TRIPLE, OPERATOR_AUTHORIZED_DRAFT_TO_READY), CURRENT(DRAFT_PR_DELIVERY_RECEIPT, PR_TRIPLE), STATE_CREATED(DRAFT_PR_DELIVERY_RECEIPT, PR_TRIPLE, DRAFT_DELIVERED), CURRENT(POST_DRAFT_DRAFT_TO_READY_BINDING_RECEIPT, PR_TRIPLE), STATE_CREATED(POST_DRAFT_DRAFT_TO_READY_BINDING_RECEIPT, PR_TRIPLE, GIT_INTEGRATOR_DRAFT_TO_READY_BOUND), CURRENT(PACKET_ASSEMBLY_RECEIPT, DRAFT_TO_READY_APPROVAL_PACKET), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, DRAFT_TO_READY_APPROVAL_PACKET, PACKET_ASSEMBLED), CURRENT(PACKET_FREEZE_RECEIPT, DRAFT_TO_READY_APPROVAL_PACKET), STATE_CREATED(PACKET_FREEZE_RECEIPT, DRAFT_TO_READY_APPROVAL_PACKET, PACKET_FROZEN), CURRENT(PACKET_VALIDATION_RECEIPT, DRAFT_TO_READY_APPROVAL_PACKET), STATE_CREATED(PACKET_VALIDATION_RECEIPT, DRAFT_TO_READY_APPROVAL_PACKET, PACKET_VALIDATED), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, READY_CROSS_VERIFICATION_REF), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, READY_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFIED), INSTANCE_SUBJECT_MATCH(ROLE_CROSS_VERIFICATION_RECEIPT, READY_CROSS_VERIFICATION_REF, READY_TRANSITION_COMPLETION_REPORT), SAME_OPERATION(DRAFT_TO_READY_APPROVAL_PACKET, DRAFT_TO_READY_OPERATION_REF, DRAFT_TO_READY_INVOCATION_REF, READY_CROSS_VERIFICATION_REF, READY_TRANSITION_COMPLETION_REPORT)) | PR_METADATA_SNAPSHOT, OPERATOR_DECISION_RECORD | READY / BLOCKED | PR_READY / PR_READY_BLOCKED |
| `POST_DRAFT_MERGE_BINDING_RECEIPT` | git-integrator (per-stage, post-Draft re-authorization for Merge operation) | stage-specific post-Draft binding for Merge operation |`MERGE_APPROVAL_PACKET` triple + git-integrator stage Activation Evidence|`MERGE_APPROVAL_PACKET`, `MERGE_OPERATION_REF`, `MERGE_INVOCATION_REF`, `PR_TRIPLE`|`OPERATOR_MERGE_AUTHORIZATION_RECEIPT`, `READY_TRANSITION_RECEIPT`, `ROLE_ACTIVATION_READINESS_RECEIPT`| AND(CURRENT(OPERATOR_MERGE_AUTHORIZATION_RECEIPT, MERGE_OPERATION_REF), STATE_CREATED(OPERATOR_MERGE_AUTHORIZATION_RECEIPT, MERGE_OPERATION_REF, OPERATOR_AUTHORIZED_MERGE), CURRENT(READY_TRANSITION_RECEIPT, PR_TRIPLE), STATE_CREATED(READY_TRANSITION_RECEIPT, PR_TRIPLE, PR_READY), CURRENT(ROLE_ACTIVATION_READINESS_RECEIPT, MERGE_INVOCATION_REF), STATE_CREATED(ROLE_ACTIVATION_READINESS_RECEIPT, MERGE_INVOCATION_REF, ROLE_ACTIVATION_READY), SAME_OPERATION(MERGE_APPROVAL_PACKET, MERGE_OPERATION_REF, MERGE_INVOCATION_REF)) | MODEL_INVOCATION_RECORD (stage-specific), GIT_OBJECT, OPERATOR_DECISION_RECORD | BOUND / UNBOUND | GIT_INTEGRATOR_MERGE_BOUND / GIT_INTEGRATOR_MERGE_UNBOUND |
| `MERGE_DELIVERY_RECEIPT` | git-integrator | operator Merge authorization + READY_TRANSITION_RECEIPT + MERGE_APPROVAL_PACKET assembly + freeze + validation + POST_DRAFT_MERGE_BINDING + git-integrator completion Evidence + STAGE_IS(MERGE) |PR triple|`MERGE_APPROVAL_PACKET`, `PR_TRIPLE`, `MERGE_OPERATION_REF`, `MERGE_INVOCATION_REF`, `MERGE_CROSS_VERIFICATION_REF`, `MERGE_COMPLETION_REPORT`|`OPERATOR_MERGE_AUTHORIZATION_RECEIPT`, `READY_TRANSITION_RECEIPT`, `POST_DRAFT_MERGE_BINDING_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `ROLE_CROSS_VERIFICATION_RECEIPT`| AND(CURRENT(OPERATOR_MERGE_AUTHORIZATION_RECEIPT, PR_TRIPLE), STATE_CREATED(OPERATOR_MERGE_AUTHORIZATION_RECEIPT, PR_TRIPLE, OPERATOR_AUTHORIZED_MERGE), CURRENT(READY_TRANSITION_RECEIPT, PR_TRIPLE), STATE_CREATED(READY_TRANSITION_RECEIPT, PR_TRIPLE, PR_READY), CURRENT(POST_DRAFT_MERGE_BINDING_RECEIPT, PR_TRIPLE), STATE_CREATED(POST_DRAFT_MERGE_BINDING_RECEIPT, PR_TRIPLE, GIT_INTEGRATOR_MERGE_BOUND), CURRENT(PACKET_ASSEMBLY_RECEIPT, MERGE_APPROVAL_PACKET), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, MERGE_APPROVAL_PACKET, PACKET_ASSEMBLED), CURRENT(PACKET_FREEZE_RECEIPT, MERGE_APPROVAL_PACKET), STATE_CREATED(PACKET_FREEZE_RECEIPT, MERGE_APPROVAL_PACKET, PACKET_FROZEN), CURRENT(PACKET_VALIDATION_RECEIPT, MERGE_APPROVAL_PACKET), STATE_CREATED(PACKET_VALIDATION_RECEIPT, MERGE_APPROVAL_PACKET, PACKET_VALIDATED), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, MERGE_CROSS_VERIFICATION_REF), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, MERGE_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFIED), INSTANCE_SUBJECT_MATCH(ROLE_CROSS_VERIFICATION_RECEIPT, MERGE_CROSS_VERIFICATION_REF, MERGE_COMPLETION_REPORT), SAME_OPERATION(MERGE_APPROVAL_PACKET, MERGE_OPERATION_REF, MERGE_INVOCATION_REF, MERGE_CROSS_VERIFICATION_REF, MERGE_COMPLETION_REPORT)) | GIT_OBJECT, PR_METADATA_SNAPSHOT | MERGED / FAILED | PR_MERGED / MERGE_FAILED |
| `POST_DRAFT_BRANCH_DELETION_BINDING_RECEIPT` | git-integrator (per-stage, post-Draft re-authorization for Branch Deletion operation) | stage-specific post-Draft binding for Branch Deletion operation |`BRANCH_DELETION_APPROVAL_PACKET` triple + git-integrator stage Activation Evidence|`BRANCH_DELETION_APPROVAL_PACKET`, `BRANCH_DELETION_OPERATION_REF`, `BRANCH_DELETION_INVOCATION_REF`, `BRANCH_TRIPLE`|`OPERATOR_BRANCH_DELETION_AUTHORIZATION_RECEIPT`, `MERGE_DELIVERY_RECEIPT`, `ROLE_ACTIVATION_READINESS_RECEIPT`| AND(CURRENT(OPERATOR_BRANCH_DELETION_AUTHORIZATION_RECEIPT, BRANCH_DELETION_OPERATION_REF), STATE_CREATED(OPERATOR_BRANCH_DELETION_AUTHORIZATION_RECEIPT, BRANCH_DELETION_OPERATION_REF, OPERATOR_AUTHORIZED_BRANCH_DELETION), CURRENT(MERGE_DELIVERY_RECEIPT, BRANCH_TRIPLE), STATE_CREATED(MERGE_DELIVERY_RECEIPT, BRANCH_TRIPLE, PR_MERGED), CURRENT(ROLE_ACTIVATION_READINESS_RECEIPT, BRANCH_DELETION_INVOCATION_REF), STATE_CREATED(ROLE_ACTIVATION_READINESS_RECEIPT, BRANCH_DELETION_INVOCATION_REF, ROLE_ACTIVATION_READY), SAME_OPERATION(BRANCH_DELETION_APPROVAL_PACKET, BRANCH_DELETION_OPERATION_REF, BRANCH_DELETION_INVOCATION_REF)) | MODEL_INVOCATION_RECORD (stage-specific), GIT_OBJECT, OPERATOR_DECISION_RECORD | BOUND / UNBOUND | GIT_INTEGRATOR_BRANCH_DELETION_BOUND / GIT_INTEGRATOR_BRANCH_DELETION_UNBOUND |
| `BRANCH_DELETION_RECEIPT` | git-integrator | operator Branch Deletion authorization + MERGE_DELIVERY + BRANCH_DELETION_APPROVAL_PACKET assembly + freeze + validation + POST_DRAFT_BRANCH_DELETION_BINDING + git-integrator completion Evidence + STAGE_IS(BRANCH_DELETION) |branch triple|`BRANCH_DELETION_APPROVAL_PACKET`, `BRANCH_TRIPLE`, `BRANCH_DELETION_OPERATION_REF`, `BRANCH_DELETION_INVOCATION_REF`, `BD_CROSS_VERIFICATION_REF`, `BRANCH_DELETION_COMPLETION_REPORT`|`OPERATOR_BRANCH_DELETION_AUTHORIZATION_RECEIPT`, `MERGE_DELIVERY_RECEIPT`, `POST_DRAFT_BRANCH_DELETION_BINDING_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `ROLE_CROSS_VERIFICATION_RECEIPT`| AND(CURRENT(OPERATOR_BRANCH_DELETION_AUTHORIZATION_RECEIPT, BRANCH_TRIPLE), STATE_CREATED(OPERATOR_BRANCH_DELETION_AUTHORIZATION_RECEIPT, BRANCH_TRIPLE, OPERATOR_AUTHORIZED_BRANCH_DELETION), CURRENT(MERGE_DELIVERY_RECEIPT, BRANCH_TRIPLE), STATE_CREATED(MERGE_DELIVERY_RECEIPT, BRANCH_TRIPLE, PR_MERGED), CURRENT(POST_DRAFT_BRANCH_DELETION_BINDING_RECEIPT, BRANCH_TRIPLE), STATE_CREATED(POST_DRAFT_BRANCH_DELETION_BINDING_RECEIPT, BRANCH_TRIPLE, GIT_INTEGRATOR_BRANCH_DELETION_BOUND), CURRENT(PACKET_ASSEMBLY_RECEIPT, BRANCH_DELETION_APPROVAL_PACKET), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, BRANCH_DELETION_APPROVAL_PACKET, PACKET_ASSEMBLED), CURRENT(PACKET_FREEZE_RECEIPT, BRANCH_DELETION_APPROVAL_PACKET), STATE_CREATED(PACKET_FREEZE_RECEIPT, BRANCH_DELETION_APPROVAL_PACKET, PACKET_FROZEN), CURRENT(PACKET_VALIDATION_RECEIPT, BRANCH_DELETION_APPROVAL_PACKET), STATE_CREATED(PACKET_VALIDATION_RECEIPT, BRANCH_DELETION_APPROVAL_PACKET, PACKET_VALIDATED), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, BD_CROSS_VERIFICATION_REF), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, BD_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFIED), INSTANCE_SUBJECT_MATCH(ROLE_CROSS_VERIFICATION_RECEIPT, BD_CROSS_VERIFICATION_REF, BRANCH_DELETION_COMPLETION_REPORT), SAME_OPERATION(BRANCH_DELETION_APPROVAL_PACKET, BRANCH_DELETION_OPERATION_REF, BRANCH_DELETION_INVOCATION_REF, BD_CROSS_VERIFICATION_REF, BRANCH_DELETION_COMPLETION_REPORT)) | GIT_OBJECT, PR_METADATA_SNAPSHOT | DELETED / FAILED | BRANCH_DELETED / BRANCH_DELETION_FAILED |
