...
- packet / receipt physical storage format (logical schema provisionally fixed in §10.3 — `PROVISIONAL_ARTIFACT_EVIDENCE_SCHEMA_PENDING_GRAY4_VALIDATION`);
- closeout schema;
- complete `VIBECODING_MODE` state machine.
