...
| `GIT_INTEGRATION_GATE_PASS_RECEIPT` | vibedev/orchestrator | REVIEW_GATE_PASS_RECEIPT for the same Git Integration operation + Integration Packet assembly + freeze + validation + PRE_DRAFT_GIT_INTEGRATOR_BINDING, where the canonical row subject is the Git Integration Packet (`INTEGRATION_INPUT_FROZEN`) | INTEGRATION_INPUT_FROZEN (the Git Integration Packet) | `INTEGRATION_INPUT_FROZEN`, CANDIDATE_TRIPLE (instance-bound, operation-bound) | `REVIEW_GATE_PASS_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`, `GIT_OPERATION_REF` | AND(CURRENT(REVIEW_GATE_PASS_RECEIPT, GIT_OPERATION_REF, GATE_PASS), CURRENT(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_ASSEMBLED), CURRENT(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_FROZEN), CURRENT(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_VALIDATED), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_OPERATION_REF, GIT_INTEGRATOR_PRE_DRAFT_BOUND), STAGE_IS(GIT_INTEGRATION), ROW_SUBJECT_IS(INTEGRATION_INPUT_FROZEN), SAME_OPERATION(INTEGRATION_INPUT_FROZEN, GIT_OPERATION_REF)) | GIT_OBJECT, DIFF_MANIFEST, PR_METADATA_SNAPSHOT | PASS | GATE_PASS |
| `GIT_INTEGRATION_GATE_FAIL_RECEIPT` | vibedev/orchestrator | integration-stage Evidence of stop or rejection on the same Git Integration operation; the canonical row subject remains the Git Integration Packet (`INTEGRATION_INPUT_FROZEN`) | INTEGRATION_INPUT_FROZEN (the Git Integration Packet) | `INTEGRATION_INPUT_FROZEN`, CANDIDATE_TRIPLE (instance-bound, operation-bound) | `ARTIFACT_VALIDATION_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`, `REVIEW_GATE_PASS_RECEIPT`, `ROLE_CROSS_VERIFICATION_RECEIPT`, `GIT_OPERATION_REF` | AND(CURRENT(REVIEW_GATE_PASS_RECEIPT, GIT_OPERATION_REF, GATE_PASS), CURRENT(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_ASSEMBLED), CURRENT(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_FROZEN), CURRENT(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_VALIDATED), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_OPERATION_REF, GIT_INTEGRATOR_PRE_DRAFT_BOUND), STAGE_IS(GIT_INTEGRATION), ROW_SUBJECT_IS(INTEGRATION_INPUT_FROZEN), SAME_OPERATION(INTEGRATION_INPUT_FROZEN, GIT_OPERATION_REF), OR(AND(CURRENT(ARTIFACT_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, ARTIFACT_VALIDATION_INVALID), DECISION(ARTIFACT_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, INVALID)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_INCOMPLETE), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, INCOMPLETE)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_REJECTED), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, REJECTED)))) | GIT_OBJECT, DIFF_MANIFEST, PR_METADATA_SNAPSHOT | FAIL | GATE_FAIL |
