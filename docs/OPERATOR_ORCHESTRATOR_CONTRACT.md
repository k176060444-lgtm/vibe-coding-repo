...
| `VERSION_INVENTORY_RECEIPT` | VERSION_PACKET | `VERSION_INVENTORY_ARTIFACT` | inventory triple | yes | no |
...
| `TESTER_A_COMPLETION_REPORT` | completion_report |
| `TESTER_B_COMPLETION_REPORT` | completion_report |
| `REVIEWER_A_COMPLETION_REPORT` | completion_report |
| `REVIEWER_B_COMPLETION_REPORT` | completion_report |
| `GIT_INTEGRATION_COMPLETION_REPORT` | completion_report |
...
| `ROLE_ACTIVATION_READINESS_RECEIPT` | vibedev/orchestrator (FULL/LIGHTWEIGHT only — not Consultation) | Global Readiness + role/node/model assignment approval |activation packet triple (per invocation)|`TESTER_A_INVOCATION_REF`, `TESTER_B_INVOCATION_REF`, `REVIEWER_A_INVOCATION_REF`, `REVIEWER_B_INVOCATION_REF`, `GIT_INTEGRATOR_ROLE_TRIPLE`, `DRAFT_TO_READY_INVOCATION_REF`, `MERGE_INVOCATION_REF`, `BRANCH_DELETION_INVOCATION_REF`, `GIT_INTEGRATOR_ACTIVATION_EVIDENCE`|`GLOBAL_READINESS_RECEIPT`, `OPERATOR_ROLE_NODE_MODEL_ASSIGNMENT_APPROVAL_RECEIPT`| AND(CURRENT(GLOBAL_READINESS_RECEIPT, WORK_ORDER_DECLARATION), STATE_CREATED(GLOBAL_READINESS_RECEIPT, WORK_ORDER_DECLARATION, GLOBAL_READINESS_ACHIEVED), INSTANCE_SUBJECT_MATCH(ROLE_ACTIVATION_READINESS_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, GIT_INTEGRATOR_ACTIVATION_EVIDENCE), INSTANCE_SUBJECT_MATCH(ROLE_ACTIVATION_READINESS_RECEIPT, TESTER_A_INVOCATION_REF, GIT_INTEGRATOR_ACTIVATION_EVIDENCE), INSTANCE_SUBJECT_MATCH(ROLE_ACTIVATION_READINESS_RECEIPT, TESTER_B_INVOCATION_REF, GIT_INTEGRATOR_ACTIVATION_EVIDENCE), INSTANCE_SUBJECT_MATCH(ROLE_ACTIVATION_READINESS_RECEIPT, REVIEWER_A_INVOCATION_REF, GIT_INTEGRATOR_ACTIVATION_EVIDENCE), INSTANCE_SUBJECT_MATCH(ROLE_ACTIVATION_READINESS_RECEIPT, REVIEWER_B_INVOCATION_REF, GIT_INTEGRATOR_ACTIVATION_EVIDENCE), INSTANCE_SUBJECT_MATCH(ROLE_ACTIVATION_READINESS_RECEIPT, DRAFT_TO_READY_INVOCATION_REF, GIT_INTEGRATOR_ACTIVATION_EVIDENCE_DRAFT_TO_READY), INSTANCE_SUBJECT_MATCH(ROLE_ACTIVATION_READINESS_RECEIPT, MERGE_INVOCATION_REF, GIT_INTEGRATOR_ACTIVATION_EVIDENCE_MERGE), INSTANCE_SUBJECT_MATCH(ROLE_ACTIVATION_READINESS_RECEIPT, BRANCH_DELETION_INVOCATION_REF, GIT_INTEGRATOR_ACTIVATION_EVIDENCE_BD)) | READINESS_CHECK, NODE_ROUTE_PROBE, MODEL_INVOCATION_RECORD | READY / BLOCKED | ROLE_ACTIVATION_READY / ROLE_ACTIVATION_BLOCKED |
...
| `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT` | git-integrator | pre-Draft git-integrator binding for Git Integration stage + Draft PR delivery |GIT_INTEGRATOR_ACTIVATION_EVIDENCE|`GIT_INTEGRATOR_ROLE_TRIPLE`, `GIT_INTEGRATOR_ACTIVATION_EVIDENCE`, `GIT_OPERATION_REF`|`OPERATOR_ROLE_NODE_MODEL_ASSIGNMENT_APPROVAL_RECEIPT`, `ROLE_ACTIVATION_READINESS_RECEIPT`| AND(CURRENT(OPERATOR_ROLE_NODE_MODEL_ASSIGNMENT_APPROVAL_RECEIPT, ROLE_NODE_MODEL_ASSIGNMENT_BASELINE_PACKET), STATE_CREATED(OPERATOR_ROLE_NODE_MODEL_ASSIGNMENT_APPROVAL_RECEIPT, ROLE_NODE_MODEL_ASSIGNMENT_BASELINE_PACKET, OPERATOR_APPROVED_ROLE_NODE_MODEL_ASSIGNMENT), CURRENT(ROLE_ACTIVATION_READINESS_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE), STATE_CREATED(ROLE_ACTIVATION_READINESS_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, ROLE_ACTIVATION_READY), INSTANCE_SUBJECT_MATCH(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, GIT_INTEGRATOR_ACTIVATION_EVIDENCE), OPERATION_MATCH(GIT_INTEGRATOR_ROLE_TRIPLE, GIT_OPERATION_REF), OPERATION_MATCH(GIT_INTEGRATOR_ACTIVATION_EVIDENCE, GIT_OPERATION_REF)) | GIT_OBJECT, PR_METADATA_SNAPSHOT, MODEL_INVOCATION_RECORD | BOUND / UNBOUND | GIT_INTEGRATOR_PRE_DRAFT_BOUND / GIT_INTEGRATOR_PRE_DRAFT_UNBOUND |
| `GIT_INTEGRATION_GATE_PASS_RECEIPT` | vibedev/orchestrator | REVIEW_GATE_PASS_RECEIPT for the same Git Integration operation + Integration Packet assembly + freeze + validation + PRE_DRAFT_GIT_INTEGRATOR_BINDING, where the canonical row subject is the Git Integration Packet (`INTEGRATION_INPUT_FROZEN`) |INTEGRATION_INPUT_FROZEN (the Git Integration Packet)|`INTEGRATION_INPUT_FROZEN`, `CANDIDATE_TRIPLE`, `REVIEW_INPUT_PACKET`, `TEST_EVIDENCE_PACKET`, `GIT_OPERATION_REF`, `GIT_INTEGRATOR_ROLE_TRIPLE`, `GIT_CROSS_VERIFICATION_REF`, `GIT_INTEGRATION_COMPLETION_REPORT`|`REVIEW_GATE_PASS_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`, `ARTIFACT_VALIDATION_RECEIPT`, `ROLE_CROSS_VERIFICATION_RECEIPT`| AND(CURRENT(REVIEW_GATE_PASS_RECEIPT, REVIEW_INPUT_PACKET), STATE_CREATED(REVIEW_GATE_PASS_RECEIPT, REVIEW_INPUT_PACKET, GATE_PASS), CURRENT(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_ASSEMBLED), CURRENT(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_FROZEN), CURRENT(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_VALIDATED), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE), STATE_CREATED(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, GIT_INTEGRATOR_PRE_DRAFT_BOUND), CURRENT(ARTIFACT_VALIDATION_RECEIPT, CANDIDATE_TRIPLE), STATE_CREATED(ARTIFACT_VALIDATION_RECEIPT, CANDIDATE_TRIPLE, ARTIFACT_VALIDATED), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFIED), INSTANCE_SUBJECT_MATCH(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, GIT_INTEGRATION_COMPLETION_REPORT), PACKET_BINDS(REVIEW_INPUT_PACKET, CANDIDATE_TRIPLE), PACKET_BINDS(INTEGRATION_INPUT_FROZEN, CANDIDATE_TRIPLE), STAGE_IS(GIT_INTEGRATION), ROW_SUBJECT_IS(INTEGRATION_INPUT_FROZEN), ROW_OPERATION_IS(GIT_OPERATION_REF), OPERATION_MATCH(REVIEW_INPUT_PACKET, REVIEW_OPERATION_REF), OPERATION_MATCH(GIT_CROSS_VERIFICATION_REF, GIT_OPERATION_REF), OPERATION_MATCH(GIT_INTEGRATOR_ROLE_TRIPLE, GIT_OPERATION_REF), OPERATION_MATCH(GIT_INTEGRATION_COMPLETION_REPORT, GIT_OPERATION_REF)) | GIT_OBJECT, DIFF_MANIFEST, PR_METADATA_SNAPSHOT | PASS | GATE_PASS |
| `GIT_INTEGRATION_GATE_FAIL_RECEIPT` | vibedev/orchestrator | integration-stage Evidence of stop or rejection on the same Git Integration operation; the canonical row subject remains the Git Integration Packet (`INTEGRATION_INPUT_FROZEN`) |INTEGRATION_INPUT_FROZEN (the Git Integration Packet)|`INTEGRATION_INPUT_FROZEN`, `CANDIDATE_TRIPLE`, `REVIEW_INPUT_PACKET`, `TEST_EVIDENCE_PACKET`, `GIT_OPERATION_REF`, `GIT_INTEGRATOR_ROLE_TRIPLE`, `GIT_CROSS_VERIFICATION_REF`, `GIT_INTEGRATION_COMPLETION_REPORT`|`ARTIFACT_VALIDATION_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`, `REVIEW_GATE_PASS_RECEIPT`, `ROLE_CROSS_VERIFICATION_RECEIPT`| AND(CURRENT(REVIEW_GATE_PASS_RECEIPT, REVIEW_INPUT_PACKET), STATE_CREATED(REVIEW_GATE_PASS_RECEIPT, REVIEW_INPUT_PACKET, GATE_PASS), CURRENT(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_ASSEMBLED), CURRENT(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_VALIDATED), CURRENT(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_FROZEN), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE), STATE_CREATED(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, GIT_INTEGRATOR_PRE_DRAFT_BOUND), PACKET_BINDS(REVIEW_INPUT_PACKET, CANDIDATE_TRIPLE), PACKET_BINDS(INTEGRATION_INPUT_FROZEN, CANDIDATE_TRIPLE), STAGE_IS(GIT_INTEGRATION), ROW_SUBJECT_IS(INTEGRATION_INPUT_FROZEN), ROW_OPERATION_IS(GIT_OPERATION_REF), OPERATION_MATCH(REVIEW_INPUT_PACKET, REVIEW_OPERATION_REF), OPERATION_MATCH(GIT_CROSS_VERIFICATION_REF, GIT_OPERATION_REF), OPERATION_MATCH(GIT_INTEGRATOR_ROLE_TRIPLE, GIT_OPERATION_REF), OPERATION_MATCH(GIT_INTEGRATION_COMPLETION_REPORT, GIT_OPERATION_REF), EXACTLY_ONE_OF(STATE_CREATED(ARTIFACT_VALIDATION_RECEIPT, CANDIDATE_TRIPLE, ARTIFACT_VALIDATED), STATE_CREATED(ARTIFACT_VALIDATION_RECEIPT, CANDIDATE_TRIPLE, ARTIFACT_VALIDATION_INVALID)), EXACTLY_ONE_OF(STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFIED), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFICATION_INCOMPLETE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFICATION_REJECTED)), INSTANCE_SUBJECT_MATCH(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, GIT_INTEGRATION_COMPLETION_REPORT), OR(AND(STATE_CREATED(ARTIFACT_VALIDATION_RECEIPT, CANDIDATE_TRIPLE, ARTIFACT_VALIDATION_INVALID), DECISION(ARTIFACT_VALIDATION_RECEIPT, CANDIDATE_TRIPLE, INVALID)), AND(STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFICATION_INCOMPLETE), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, INCOMPLETE)), AND(STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, ROLE_CROSS_VERIFICATION_REJECTED), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_CROSS_VERIFICATION_REF, REJECTED)))) | GIT_OBJECT, DIFF_MANIFEST, PR_METADATA_SNAPSHOT | FAIL | GATE_FAIL |
| `DRAFT_PR_DELIVERY_RECEIPT` | git-integrator | GIT_INTEGRATION_GATE_PASS_RECEIPT + CANDIDATE_TRIPLE + PR |PR_TRIPLE|`PR_TRIPLE`, `GIT_OPERATION_REF`|`GIT_INTEGRATION_GATE_PASS_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`| AND(CURRENT(GIT_INTEGRATION_GATE_PASS_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(GIT_INTEGRATION_GATE_PASS_RECEIPT, INTEGRATION_INPUT_FROZEN, GATE_PASS), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE), STATE_CREATED(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, GIT_INTEGRATOR_PRE_DRAFT_BOUND), INSTANCE_SUBJECT_MATCH(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, GIT_INTEGRATOR_ACTIVATION_EVIDENCE), ROW_OPERATION_IS(GIT_OPERATION_REF)) | GIT_OBJECT, PR_METADATA_SNAPSHOT | DELIVERED / FAILED | DRAFT_DELIVERED / DRAFT_DELIVERY_FAILED |
