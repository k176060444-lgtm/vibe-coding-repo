...
| `PACKET_ASSEMBLY_RECEIPT` | assembler (vibedev/orchestrator) | assembly completion of the operation-specific Packet | assembled Packet triple; PACKET_OPERATION_REF (per-stage operation type: `INTEGRATION_OPERATION_REF`, `DRAFT_TO_READY_OPERATION_REF`, `MERGE_OPERATION_REF`, `BRANCH_DELETION_OPERATION_REF`, `VERSION_OPERATION_REF`, `PACKET_OPERATION_REF` for general) | ∅ | `EXPLORER_VALIDATION_RECEIPT`, `PLAN_VALIDATION_RECEIPT`, `ARTIFACT_VALIDATION_RECEIPT` | AND(CURRENT(ARTIFACT_VALIDATION_RECEIPT), ROW_OPERATION_IS(PACKET_OPERATION_REF), OR(AND(PACKET_CLASS_IS(FULL_EXECUTION), CURRENT(EXPLORER_VALIDATION_RECEIPT), CURRENT(PLAN_VALIDATION_RECEIPT), STATE_CREATED(PLAN_VALIDATION_RECEIPT, PLAN_VALIDATED), SAME_OPERATION(PACKET_OPERATION_REF, INTEGRATION_OPERATION_REF)), AND(PACKET_CLASS_IS(LIGHTWEIGHT_WITH_PLANNER), CURRENT(EXPLORER_VALIDATION_RECEIPT), CURRENT(PLAN_VALIDATION_RECEIPT), SAME_OPERATION(PACKET_OPERATION_REF, INTEGRATION_OPERATION_REF)), AND(PACKET_CLASS_IS(LIGHTWEIGHT_DIRECT_TO_IMPLEMENTER), SAME_OPERATION(PACKET_OPERATION_REF, INTEGRATION_OPERATION_REF)), AND(PACKET_CLASS_IS(VERSION_GOVERNANCE), SAME_OPERATION(PACKET_OPERATION_REF, VERSION_OPERATION_REF)), AND(PACKET_CLASS_IS(DRAFT_TO_READY_APPROVAL), SAME_OPERATION(PACKET_OPERATION_REF, DRAFT_TO_READY_OPERATION_REF)), AND(PACKET_CLASS_IS(MERGE_APPROVAL), SAME_OPERATION(PACKET_OPERATION_REF, MERGE_OPERATION_REF)), AND(PACKET_CLASS_IS(BRANCH_DELETION_APPROVAL), SAME_OPERATION(PACKET_OPERATION_REF, BRANCH_DELETION_OPERATION_REF)), AND(PACKET_CLASS_IS(CONSULTATION_SOURCE)))) | DIFF_MANIFEST, TREE_MANIFEST | ASSEMBLED | PACKET_ASSEMBLED |
| `PACKET_FREEZE_RECEIPT` | vibedev/orchestrator | Packet assembly confirmation; freezes the same Packet for its stage operation | Packet triple + `PACKET_OPERATION_REF` | ∅ | `PACKET_ASSEMBLY_RECEIPT` | AND(CURRENT(PACKET_ASSEMBLY_RECEIPT), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, PACKET_ASSEMBLED), SAME_OPERATION(PACKET_ASSEMBLY_RECEIPT, ROW_OPERATION_IS(PACKET_OPERATION_REF))) | FILE_SNAPSHOT, GIT_OBJECT | FROZEN | PACKET_FROZEN |
| `PACKET_VALIDATION_RECEIPT` | vibedev/orchestrator | Packet freeze confirmation; validates the same Packet for its stage operation | Packet triple + `PACKET_OPERATION_REF` | ∅ | `PACKET_FREEZE_RECEIPT` | AND(CURRENT(PACKET_FREEZE_RECEIPT), STATE_CREATED(PACKET_FREEZE_RECEIPT, PACKET_FROZEN), SAME_OPERATION(PACKET_FREEZE_RECEIPT, ROW_OPERATION_IS(PACKET_OPERATION_REF))) | DIFF_MANIFEST, TREE_MANIFEST, TEST_RESULT | VALIDATED / INVALID | PACKET_VALIDATED / PACKET_VALIDATION_FAILED |
| `PACKET_CONSUMPTION_RECEIPT` | consumer role/stage controller (vibedev/orchestrator) | consumes the frozen (optionally validated) Packet for the downstream stage; Packet consumption is bound to the consumer's stage operation | Packet triple + `PACKET_OPERATION_REF` | ∅ | `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT` | AND(CURRENT(PACKET_FREEZE_RECEIPT), CURRENT(PACKET_VALIDATION_RECEIPT), STATE_CREATED(PACKET_FREEZE_RECEIPT, PACKET_FROZEN), STATE_CREATED(PACKET_VALIDATION_RECEIPT, PACKET_VALIDATED), SAME_OPERATION(PACKET_FREEZE_RECEIPT, ROW_OPERATION_IS(PACKET_OPERATION_REF))) | CONSUMER_EVIDENCE | CONSUMED | PACKET_CONSUMED |
| `TEST_GATE_PASS_RECEIPT` | vibedev/orchestrator | tester-a + tester-b independent cross-verification on the same CANDIDATE_TRIPLE, input Packet freeze, stage operation, and role/model invocation refs | test evidence packet triple (`TEST_EVIDENCE_PACKET`) |`TESTER_A_INPUT_PACKET`, `TESTER_B_INPUT_PACKET`, `TESTER_A_INVOCATION_REF`, `TESTER_B_INVOCATION_REF`|`ROLE_CROSS_VERIFICATION_RECEIPT`, `PACKET_FREEZE_RECEIPT`| AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE, ROLE_CROSS_VERIFIED), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE, ROLE_CROSS_VERIFIED), CURRENT(PACKET_FREEZE_RECEIPT), STAGE_IS(TEST), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, ROLE_CROSS_VERIFIED), ROW_OPERATION_IS(TEST_OPERATION_REF)) | TEST_RESULT, MODEL_INVOCATION_RECORD | PASS | GATE_PASS |
| `TEST_GATE_FAIL_RECEIPT` | vibedev/orchestrator | at least one of tester-a / tester-b reports an instance-level INCOMPLETE or REJECTED on the same CANDIDATE_TRIPLE, with the other tester explicitly resolved | test evidence packet triple (`TEST_EVIDENCE_PACKET`) |`TESTER_A_INPUT_PACKET`, `TESTER_B_INPUT_PACKET`, `TESTER_A_INVOCATION_REF`, `TESTER_B_INVOCATION_REF`|`ROLE_CROSS_VERIFICATION_RECEIPT`, `PACKET_FREEZE_RECEIPT`| AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE), CURRENT(PACKET_FREEZE_RECEIPT), STAGE_IS(TEST), ROW_OPERATION_IS(TEST_OPERATION_REF), OR(AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_INCOMPLETE), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE, INCOMPLETE)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_REJECTED), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_A_ROLE_TRIPLE, REJECTED)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_INCOMPLETE), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE, INCOMPLETE)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_REJECTED), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, TESTER_B_ROLE_TRIPLE, REJECTED)))) | TEST_RESULT, MODEL_INVOCATION_RECORD | FAIL | GATE_FAIL |
| `REVIEW_GATE_PASS_RECEIPT` | vibedev/orchestrator | reviewer-a + reviewer-b independent cross-verification on the same frozen REVIEW_INPUT_PACKET and CANDIDATE_TRIPLE, with prior TEST_GATE_PASS_RECEIPT for the same stage operation, plus role/model invocation refs | review input packet triple (`REVIEW_INPUT_PACKET`) |`REVIEW_INPUT_PACKET`, `REVIEWER_A_INVOCATION_REF`, `REVIEWER_B_INVOCATION_REF`|`ROLE_CROSS_VERIFICATION_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `TEST_GATE_PASS_RECEIPT`| AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE, ROLE_CROSS_VERIFIED), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE, ROLE_CROSS_VERIFIED), CURRENT(PACKET_FREEZE_RECEIPT), CURRENT(TEST_GATE_PASS_RECEIPT), STATE_CREATED(TEST_GATE_PASS_RECEIPT, GATE_PASS), STAGE_IS(REVIEW), ROW_OPERATION_IS(REVIEW_OPERATION_REF)) | MODEL_INVOCATION_RECORD, FILE_SNAPSHOT | PASS | GATE_PASS |
| `REVIEW_GATE_FAIL_RECEIPT` | vibedev/orchestrator | at least one of reviewer-a / reviewer-b reports an instance-level INCOMPLETE or REJECTED on the same REVIEW_INPUT_PACKET and CANDIDATE_TRIPLE, with the other reviewer explicitly resolved; TEST_GATE_PASS remains valid | review input packet triple (`REVIEW_INPUT_PACKET`) |`REVIEW_INPUT_PACKET`, `REVIEWER_A_INVOCATION_REF`, `REVIEWER_B_INVOCATION_REF`|`ROLE_CROSS_VERIFICATION_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `TEST_GATE_PASS_RECEIPT`| AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE), CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE), CURRENT(PACKET_FREEZE_RECEIPT), CURRENT(TEST_GATE_PASS_RECEIPT), STATE_CREATED(TEST_GATE_PASS_RECEIPT, GATE_PASS), STAGE_IS(REVIEW), ROW_OPERATION_IS(REVIEW_OPERATION_REF), OR(AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_INCOMPLETE), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE, INCOMPLETE)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_REJECTED), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_A_ROLE_TRIPLE, REJECTED)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_INCOMPLETE), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE, INCOMPLETE)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_REJECTED), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, REVIEWER_B_ROLE_TRIPLE, REJECTED)))) | MODEL_INVOCATION_RECORD, FILE_SNAPSHOT | FAIL | GATE_FAIL |
...
| `GIT_INTEGRATION_GATE_PASS_RECEIPT` | vibedev/orchestrator | REVIEW_GATE_PASS_RECEIPT for the same Git Integration operation + Integration Packet assembly + freeze + validation + PRE_DRAFT_GIT_INTEGRATOR_BINDING, where the canonical row subject is the Git Integration Packet (`INTEGRATION_INPUT_FROZEN`) | INTEGRATION_INPUT_FROZEN (the Git Integration Packet) |`INTEGRATION_INPUT_FROZEN`, `GIT_OPERATION_REF`|`REVIEW_GATE_PASS_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`| AND(CURRENT(REVIEW_GATE_PASS_RECEIPT, GIT_OPERATION_REF), STATE_CREATED(REVIEW_GATE_PASS_RECEIPT, GIT_OPERATION_REF, GATE_PASS), CURRENT(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_ASSEMBLED), CURRENT(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_FROZEN), CURRENT(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_VALIDATED), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_OPERATION_REF), STATE_CREATED(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_OPERATION_REF, GIT_INTEGRATOR_PRE_DRAFT_BOUND), STAGE_IS(GIT_INTEGRATION), ROW_SUBJECT_IS(INTEGRATION_INPUT_FROZEN), SAME_OPERATION(INTEGRATION_INPUT_FROZEN, GIT_OPERATION_REF)) | GIT_OBJECT, DIFF_MANIFEST, PR_METADATA_SNAPSHOT | PASS | GATE_PASS |
| `GIT_INTEGRATION_GATE_FAIL_RECEIPT` | vibedev/orchestrator | integration-stage Evidence of stop or rejection on the same Git Integration operation; the canonical row subject remains the Git Integration Packet (`INTEGRATION_INPUT_FROZEN`) | INTEGRATION_INPUT_FROZEN (the Git Integration Packet) |`INTEGRATION_INPUT_FROZEN`, `GIT_OPERATION_REF`|`ARTIFACT_VALIDATION_RECEIPT`, `PACKET_ASSEMBLY_RECEIPT`, `PACKET_FREEZE_RECEIPT`, `PACKET_VALIDATION_RECEIPT`, `PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT`, `REVIEW_GATE_PASS_RECEIPT`, `ROLE_CROSS_VERIFICATION_RECEIPT`| AND(CURRENT(REVIEW_GATE_PASS_RECEIPT, GIT_OPERATION_REF), STATE_CREATED(REVIEW_GATE_PASS_RECEIPT, GIT_OPERATION_REF, GATE_PASS), CURRENT(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_ASSEMBLY_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_ASSEMBLED), CURRENT(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_FREEZE_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_FROZEN), CURRENT(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(PACKET_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, PACKET_VALIDATED), CURRENT(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_OPERATION_REF), STATE_CREATED(PRE_DRAFT_GIT_INTEGRATOR_BINDING_RECEIPT, GIT_OPERATION_REF, GIT_INTEGRATOR_PRE_DRAFT_BOUND), STAGE_IS(GIT_INTEGRATION), ROW_SUBJECT_IS(INTEGRATION_INPUT_FROZEN), SAME_OPERATION(INTEGRATION_INPUT_FROZEN, GIT_OPERATION_REF), OR(AND(CURRENT(ARTIFACT_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN), STATE_CREATED(ARTIFACT_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, ARTIFACT_VALIDATION_INVALID), DECISION(ARTIFACT_VALIDATION_RECEIPT, INTEGRATION_INPUT_FROZEN, INVALID)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_INCOMPLETE), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, INCOMPLETE)), AND(CURRENT(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE), STATE_CREATED(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, ROLE_CROSS_VERIFICATION_REJECTED), DECISION(ROLE_CROSS_VERIFICATION_RECEIPT, GIT_INTEGRATOR_ROLE_TRIPLE, REJECTED)))) | GIT_OBJECT, DIFF_MANIFEST, PR_METADATA_SNAPSHOT | FAIL | GATE_FAIL |
