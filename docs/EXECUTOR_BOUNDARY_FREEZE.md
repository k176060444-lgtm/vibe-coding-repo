...
## Recovery Plan
Recovery plans generated by vibe_executor_recovery.py. Covers 8 failure types with specific recovery strategies.

## Unfreeze Plan
Graduated unfreeze plan defined in docs/EXECUTOR_UNFREEZE_PLAN.md (Level 0-4).
