...
EXACT_ALIAS_MAP = {
    ...
    # opencode-go aliases (added by I15)
    "opencode-ds4flash": "opencode-go-deepseek-v4-flash",
    "opencode-deepseek-v4-flash": "opencode-go-deepseek-v4-flash",
    "opencode-glm52": "opencode-go-glm-5-2",
    "opencode-glm-5.2": "opencode-go-glm-5-2",
    "opencode-glm51": "opencode-go-glm-5-1",
    "opencode-glm-5.1": "opencode-go-glm-5-1",
    "opencode-kimi26": "opencode-go-kimi-k2-6",
    "opencode-kimi-k2.6": "opencode-go-kimi-k2-6",
    "opencode-qwen37max": "opencode-go-qwen3-7-max",
    "opencode-qwen3.7-max": "opencode-go-qwen3-7-max",
    "opencode-qwen37plus": "opencode-go-qwen3-7-plus",
    "opencode-qwen3.7-plus": "opencode-go-qwen3-7-plus",
    "opencode-mimopro": "opencode-go-mimo-v2-5-pro",
